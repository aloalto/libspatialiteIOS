...
Pod::Spec.new do |spec|
  ...
  This module includes sqlite3, geos, proj4 and spatialite.
                   DESC

  spec.homepage     = "https://github.com/smellman/libspatialite-ios"
  ...
  spec.license      = { :type => "Mozilla Public License v1.1, LGPL, MIT", :file => "COPYING" }
  ...
  spec.pod_target_xcconfig = { 'OTHER_LDFLAGS' => "-lsqlite3 -lspatialite -lgeos_c -lgeos -lproj" }
end
